...
private:
	...
	//naodai sub nx message//
	ros::Subscriber motor_sub;
	ros::Subscriber light_sub;
	ros::Subscriber gripper_sub;
	
	// naodai re_power t265
    // ros::Subscriber t265_rePower_sub;
	...
	// naodai	
	// motor 
	void mavlink_sub_motor(const mavros_msgs::ActuatorControl::ConstPtr &req);
    // light
	void mavlink_sub_light(const mavros_msgs::Param::ConstPtr &req);
	// gripper 
	void mavlink_sub_gripper(const mavros_msgs::Thrust::ConstPtr &req);
	// t265 power
	// void mavlink_sub_t265_rePower(const mavros_msgs::ParamValue::ConstPtr &req);
